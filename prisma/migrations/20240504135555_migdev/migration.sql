/*
  ...
  - You are about to drop the column `intend_id` on the `Order` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Order_intend_id_key";

-- AlterTable
ALTER TABLE "Order" DROP COLUMN "intend_id",
